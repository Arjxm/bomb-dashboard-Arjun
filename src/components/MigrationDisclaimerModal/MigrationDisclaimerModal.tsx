...
const MigrationDisclaimerModal: React.FC<MigrationDisclaimerModalProps> = ({onConfirm, onDismiss}) => {
    ...
    return (
        <Modal>
            ...
            <div>
                <StyledText>
                    Due to the upgrade, all Boardroom functionalities other than [Settle and withdraw] has been disabled
                    for users
                    who staked in legacy Boardroom. Please withdraw all balances from the previous boardroom after the
                    update.
                </StyledText>
            </div>
            <ModalActions>
